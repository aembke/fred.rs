...
#[cfg(feature = "mocks")]
use crate::{
  commands::scan::ValueScanResult,
  runtime::Sender,
  types::mocks::MockCommand,
  types::scan::ScanResult,
  types::values::Key,
};
use crate::{
  commands::{responders::ResponseKind, ResponseSender},
  error::{Error, ErrorKind},
  inner::ClientInner,
  net::{protocol, protocol::ProtocolFrame},
  runtime::{AtomicBool, OneshotSender, RefCount},
  trace,
  types::{hashers::ClusterHash, values::Value, Resp3Frame, Server},
...
impl Command {
  ...
  pub fn to_frame(&self, is_resp3: bool) -> Result<ProtocolFrame, Error> {
    protocol::command_to_frame(self, is_resp3)
  }
